...
def generate_rooms(apps, schema_editor):
    ...
    roads = [p_dirt_path, p_borg_path, p_desert_path, p_imagination_road, p_mushroom_road]
    ...
    # marvel = [r_adamantium, r_america, r_aquarium, r_bullseye, r_cerebro, r_dead_pool, r_hawk, r_ice, r_lightning, r_pitch_black, r_rock, r_science, r_skull, r_small, r_smash, r_stark, r_tourch, r_web]
    # for b in marvel: b.save()
